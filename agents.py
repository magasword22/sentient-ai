...
def run_cyber_crew(target_desc, nuclei_results, rag_context, language="Français"):
    ...
    if "anglais" in lang_lower or "english" in lang_lower:
        ...
        triage_desc = (
            ...
            "2. El host afectado.\n"
            "3. La severidad.\n"
            "4. La URL de un PoC público si encontró uno a través de su búsqueda; de lo contrario, indique 'No se identificó ningún PoC público'."
        )
        ...
        # Placeholders
        t_exec_placeholder = "Escriba un resumen ejecutivo global aquí en 3 líneas"
